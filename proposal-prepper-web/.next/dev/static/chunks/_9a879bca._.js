 ...
 */ function createAIRouterClient() {
    ...
    let config;
    try {
        const configModule = __turbopack_context__.r("[project]/proposal-prepper-web/src/config/api-config.ts [app-client] (ecmascript)");
        config = configModule.apiConfiguration;
    } catch (_error) {
        // Fallback configuration if api-config is not available
        const baseUrl = __TURBOPACK__imported__module__$5b$project$5d2f$proposal$2d$prepper$2d$web$2f$src$2f$config$2f$app$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiConfig"].useMockApis ? 'http://localhost:3000' : __TURBOPACK__imported__module__$5b$project$5d2f$proposal$2d$prepper$2d$web$2f$src$2f$config$2f$app$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiConfig"].strandsBaseUrl;
        config = {
            baseUrl,
            useMock: __TURBOPACK__imported__module__$5b$project$5d2f$proposal$2d$prepper$2d$web$2f$src$2f$config$2f$app$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiConfig"].useMockApis
        };
    }
...
_s(App, "xMHOKXQNgZ2tdtdCkxJ39T0IZ6U=");
_c = App;
var _c;
...
//# sourceMappingURL=_9a879bca._.js.map